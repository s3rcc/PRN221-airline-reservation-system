...
namespace PRN___Final_Project.Pages.CRUD.FlightManager
{
    public class ReturnFlightsModel : PageModel
    {
        ...
        public ReturnFlightsModel(IFlightService flightService, ILocationService locationService, IOptions<ClassTypesConfig> classTypesConfig, IOptions<TicketTypesConfig> ticketTypesConfig)
        {
